# 🍽️ AIOSK - 키오스크 백엔드 시스템

> **All-In-One Smart Kiosk** 백엔드 API 서버 - 현대적인 키오스크 서비스를 위한 완전한 솔루션
...
**AIOSK**는 현대적인 레스토랑 키오스크 서비스를 위한 **엔터프라이즈급 백엔드 API 시스템**입니다.  
실시간 주문 처리, 메뉴 관리, 통계 분석, 파일 업로드 등 키오스크 운영에 필요한 모든 기능을 제공합니다.
